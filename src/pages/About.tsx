    ...
    <Layout>
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-12 mb-12">
          <div className="flex-shrink-0">
            <img
              ...
              className="w-48 h-48 object-cover profile-90s"
            />
          </div>
        ...
        <div className="grid gap-8">
          <section className="bg-card backdrop-blur-lg rounded-lg p-8 bevel-border">
            <h2 className="text-2xl font-bold mb-4 text-90s-pink">Professional Background</h2>
          ...
          <section className="bg-card backdrop-blur-lg rounded-lg p-8 bevel-border">
            <h2 className="text-2xl font-bold mb-4 text-90s-lime">Personal Journey</h2>
            <div className="space-y-4 text-foreground leading-relaxed">
              <p>
          ...
          <section className="bg-card backdrop-blur-lg rounded-lg p-8 bevel-border">
            <h2 className="text-2xl font-bold mb-4 text-90s-blue">Life in New York</h2>
            <div className="space-y-4 text-foreground leading-relaxed">
              <p>
          ...
          <section className="bg-card backdrop-blur-lg rounded-lg p-8 bevel-border">
            <h2 className="text-2xl font-bold mb-4 text-90s-pink">Philosophy & Approach</h2>
            <div className="space-y-4 text-foreground leading-relaxed">
              <p>
